...
('10000000-0000-4000-8000-000000000001', 'f0000000-0000-4000-8000-000000000001', 'operator', 'Standard security operator', TRUE),
('10000000-0000-4000-8000-000000000002', 'f0000000-0000-4000-8000-000000000001', 'supervisor', 'Shift supervisor with escalation authority', TRUE),
('10000000-0000-4000-8000-000000000003', 'f0000000-0000-4000-8000-000000000001', 'admin', 'Facility administrator', TRUE),
('10000000-0000-4000-8000-000000000004', 'f0000000-0000-4000-8000-000000000001', 'platform_admin', 'Platform-wide administrator', TRUE);

-- Permissions
INSERT INTO permissions (id, resource, action, description) VALUES
('20000000-0000-4000-8000-000000000001', 'alerts', 'read', 'View alerts and threat feed'),
('20000000-0000-4000-8000-000000000002', 'alerts', 'acknowledge', 'Acknowledge alerts'),
('20000000-0000-4000-8000-000000000003', 'alerts', 'escalate', 'Escalate alerts to supervisor'),
('20000000-0000-4000-8000-000000000004', 'sensors', 'read', 'View sensor status'),
('20000000-0000-4000-8000-000000000005', 'sensors', 'write', 'Update sensor configuration'),
('20000000-0000-4000-8000-000000000006', 'zones', 'read', 'View zone data'),
('20000000-0000-4000-8000-000000000007', 'leaderboard', 'read', 'View leaderboard'),
('20000000-0000-4000-8000-000000000008', 'operators', 'read', 'View operator list'),
('20000000-0000-4000-8000-000000000009', 'operators', 'write', 'Manage operators'),
('20000000-0000-4000-8000-000000000010', 'admin', 'read', 'Access admin dashboard'),
('20000000-0000-4000-8000-000000000011', 'admin', 'write', 'Modify admin settings'),
('20000000-0000-4000-8000-000000000012', 'audit_log', 'read', 'View audit log'),
('20000000-0000-4000-8000-000000000013', 'compliance', 'read', 'View compliance reports'),
('20000000-0000-4000-8000-000000000014', 'compliance', 'write', 'Manage compliance settings');
...
('10000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000007'),
('10000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000008'),
...
('10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000006'),
('10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000007'),
('10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000008'),
('10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000009'),
('10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000010'),
('10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000011'),
('10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000012'),
('10000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000013'),
...
('10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000003'),
('10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000004'),
('10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000005'),
('10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000006'),
('10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000007'),
...
('10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000010'),
('10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000011'),
('10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000012'),
('10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000013'),
('10000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000014');

-- Operator-Role assignments
INSERT INTO operator_roles (operator_id, role_id, granted_by, granted_at) VALUES
('e0000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', 'e0000000-0000-4000-8000-000000000005', NOW() - INTERVAL '30 days'),
('e0000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', 'e0000000-0000-4000-8000-000000000005', NOW() - INTERVAL '28 days'),
('e0000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000002', 'e0000000-0000-4000-8000-000000000005', NOW() - INTERVAL '25 days'),
('e0000000-0000-4000-8000-000000000004', '10000000-0000-4000-8000-000000000001', 'e0000000-0000-4000-8000-000000000005', NOW() - INTERVAL '14 days'),
('e0000000-0000-4000-8000-000000000005', '10000000-0000-4000-8000-000000000004', NULL, NOW() - INTERVAL '60 days');
